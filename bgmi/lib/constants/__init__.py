...
actions_and_arguments = [{'action': ACTION_ADD,
                          'help': 'Subscribe bangumi.',
                          'arguments': [{'dest': 'name',
                                         'kwargs': dict(metavar='name',
                                                        nargs='+',
                                                        help='Bangumi name'),
                                         },
                                        {'dest': '--episode',
                         ...
                         {'action': ACTION_MARK,
                          ...
                          'arguments': [{'dest': 'name',
                                        ...
                                        {'dest': 'episode',
                                         'kwargs': dict(help='Bangumi episode',
                                                        type=int),
                                         },
                                        ],
                          },
                         {'action': ACTION_DOWNLOAD,
                          ...
                          'arguments': [{'dest': '--list',
                                         'kwargs': dict(help='List download queue.',
                                                        action='store_true'),
                                         },
                                        {'dest': '--mark',
                                         'kwargs': dict(help='Mark download status with a specific id.',
                                                        dest='id',
                                                        type=int),
                                         },
                                        {'dest': '--status',
                         ...
                         {'action': ACTION_SEARCH,
                          ...
                          'arguments': [{'dest': 'keyword',
                                        ...
                                        {'dest': '--min-episode',
                                         'kwargs': dict(metavar='min_episode',
                                                        type=int,
                                                        help='Minimum episode filter of title.'),
                                         },
                                        {'dest': '--max-episode',
                                         'kwargs': dict(metavar='max_episode',
                                                        type=int,
                         ...
                         {'action': ACTION_CONFIG_GEN,
                          ...
                          'arguments': [{'dest': 'config',
                                         'kwargs': dict(help='gen nginx.conf',
                                                        choices=['nginx.conf',
                                                                 'bgmi_http.service',
                                                                 ])},
                                        {'dest': '--server-name',
                                         'kwargs': dict(metavar='server_name',
                                                        help='nginx server name')},
                                        ]},
                         {'action': ACTION_LINK,
                          'help': 'Combine two bangumi which not auto combined by bgmi',
                          'arguments': [{'dest': 'bangumi_names',
                                         'kwargs': dict(nargs='*')}]},
